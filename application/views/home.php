	...
	<section class="oportunidades">
		...
		<article class="indexSliderContenedor" id="indexSliderContenedor">
			...
			<figure class="mySlide" style="display: block;">
				<a href="">
			  		<img class="mySlideImg" src="/images/casa02.jpg" alt="foto de la propiedad">
			...
			<figure class="mySlide" style="display: block;">
				<a href="">
					<img  class="mySlideImg" src="/images/casa04.jpg" alt="foto de la propiedad">
			...
			<figure class="mySlide" style="display: block;">
				<a href="">
					<img class="mySlideImg" src="/images/terreno01.jpg" alt="foto de la propiedad">
			...
			<figure class="mySlide" style="display: block;">
				<a href="">
			  		<img class="mySlideImg" src="/images/terreno02.jpg" alt="foto de la propiedad">
			...
			<figure class="mySlide" style="display: block;">
				<a href="">
					<img class="mySlideImg" src="/images/terreno03.jpg" alt="foto de la propiedad">
